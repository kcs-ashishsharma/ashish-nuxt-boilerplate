    ...
    <div class="login-wrapper">
        <div class="login-card">
           <div class="brand-logo">
                ...
                <div class="title">Chane Your Password</div>
                <div class="sub-title">
            ...
            <form @submit.prevent="submitForm">
                <div class="username-field">
                    ...
                    <input v-model="formData.email" type="text" name="email"
                        :class="$v.email.$error ? 'error-input' : 'valid-input'" @change="$v.email.$touch"
                        autocomplete="off" />
                ...
                <!-- <div class="password-field">
                    ...
                    <input v-model="formData.password" type="password" name="password"
                        :class="$v.password.$error ? 'error-input' : 'valid-input'" @change="$v.password.$touch"
                        autocomplete="off" />
                    <span class="error-message" v-if="$v.password.$error">{{ $v.password.$errors[0].$message }}</span>
                    <span class="error-message" v-if="!$v.password.$error && wrongPasswordError">{{ wrongPasswordError
                    }}</span>
                </div> -->
               ...
               <div class="sign-in-cerate-account">
                ...
                <!-- <div class="new-modernize-create-new-account">
                    Let's join with us<nuxt-link to="" class="create-new-account">Create an account</nuxt-link>
                </div> -->
            </form>
        </div>
    </div>
